...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Export validation_lists as markdown and CSV references.",
    )
    parser.add_argument("workbook", type=Path)
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("docs/reference/validation_choices.md"),
        help="Markdown output path.",
    )
    parser.add_argument(
        "--csv-output",
        type=Path,
        default=Path("docs/reference/validation_choices.csv"),
