...
from backend.wordpress_api import request_json

PLUGIN_FILE = "speech2post-rest-compat/speech2post-rest-compat.php"
PLUGIN_FILES = {
    PLUGIN_FILE,
    "speech2post-rest-compat/speech2post-rest-compat",
}
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Check or activate the already-uploaded Speech2Post REST compatibility "
            ...
            json.dumps(
                {
                    ...
                    "next_action": (
                        "Upload dist/speech2post-rest-compat.zip in WordPress Admin, "
