...
def test_image_metadata_taxonomy_terms_are_limited_to_exact_candidates() -> None:
    model = build_image_metadata_batch_model(
        [],
        media_ids=("image-1",),
        taxonomy_candidates={
    ...
    assert result.images[0].visible_taxonomy_terms.cocktails == ["Mojito"]
